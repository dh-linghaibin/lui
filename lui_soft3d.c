...
unsigned int * xxff = NULL;
device_t device;

unsigned char *screen_fb = NULL;

void x3d_init(void) {
    device_init(&device, 200, 200, screen_fb);
        xxff = device.framebuffer;
